...
@section('content')
    ...
    <form action="{{ route('users.update',$user->id) }}" method="post" class="custom-form">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="tel" class="form-control" name="mobile" id="mobile" required value="{{$user->mobile}}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="role" id="roles" required>
                    ...
                    <option value="delivery" @if($user->role == 'delivery') selected @endif>Delivery</option>
                </select>
                @if ($errors->has('role'))
